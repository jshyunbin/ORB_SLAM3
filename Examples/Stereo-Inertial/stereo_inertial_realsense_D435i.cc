...
int main(int argc, char **argv) {
    ...
    std::string bag_path;
    app.add_option("-b,--bag_path", bag_path)->required();
    ...
    ORB_SLAM3::System SLAM(
        vocabulary,                     // path_to_vocabulary
        setting,                        // path_to_settings
        ORB_SLAM3::System::IMU_STEREO,  // sensor type
        enable_gui,                     // bUseViewer (Viewer 사용)
        load_map,                       // load_atlas_path (아틀라스 로드 안 함)
        save_map,                       // save_atlas_path (궤적 파일명으로 사용)
        aruco_dict,                     // aruco_dict (Aruco 딕셔너리 사용 안 함)
        init_tag_id,                    // init_tag_id
        init_tag_size                   // init_tag_size
    );
    ...
    while (!SLAM.isShutDown())
    {
        ...
        // mask check
        // std::string output_path = "/home/sungjoon/Desktop/im.png";
        // bool success = cv::imwrite(output_path, im);

        // output_path = "/home/sungjoon/Desktop/imRight.png";
        // cv::imwrite(output_path, imRight);
        
        // if (success)
        // {
        //     std::cout << "Saved im to " << output_path << std::endl;
        // }
        // else
        // {
        //     std::cerr << "Error: Failed to save im to " << output_path << std::endl;
        // }
        // break;
